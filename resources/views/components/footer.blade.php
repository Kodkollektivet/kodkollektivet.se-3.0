...
<footer class="footer py-20 text-base-content max-w-2xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8 lg:flex lg:justify-between">
    <div>
...
<footer class="footer flex items-center justify-center p-4 bg-neutral w-full">
    <div class="flex items-center justify-between w-full text-neutral-content max-w-2xl mx-auto lg:max-w-7xl lg:px-6">
        <div class="items-center grid-flow-col">
          ...
          <div class="flex flex-nowrap xs:gap-2 sm:gap-2 md:gap-4 lg:gap-4 md:place-self-center md:justify-self-end relative -mr-1">
